ou stop falling through time, catch your breath, and check the screen on
...
"Wouldn't they have had enough fabric to fill several boxes in
the warehouse? They'd be stored together, so the box IDs should be
